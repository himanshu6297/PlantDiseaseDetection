...
async def startup_event():
    ...
    try:
        ...
        # Define class names (38 Plant Village classes)
        class_names = [
            "Apple___Black_rot",
            ...
            "Peach___Powdery_mildew",
            "Peach___healthy",
            "Pepper_bell___Bacterial_spot",
            "Pepper_bell___Target_Spot",
            "Pepper_bell___healthy",
            "Potato___Early_blight",
            "Potato___Late_blight",
            "Potato___healthy",
            "Raspberry___Septoria_leaf_spot",
            "Raspberry___healthy",
            ...
            "Tomato___Two_spotted_spider_mite",
            "Tomato___healthy",
        ]
